...
## synced to the s3 bucket with the URL:
## https://git-scripts-sync.s3.us-west-2.amazonaws.com/cloudformation/create-cicd-pipeline.yaml
##
## Params:
##  -p CICD pipeline project (e.g. web-stack-dev)
##  -s CloudFormation stack name (e.g. web-stack-dev-infra)
##  -a AWS Account ID
##  -r AWS Account region (e.g. us-west-2)
##  -h help
##
